	...
	<div class="container">
		<div class="row mb-5 justify-content-center">
			<div class="col-lg-6 text-center">
				...
				<p>Explore the world with our comprehensive tourism management system, offering seamless travel experiences and unforgettable adventures.</p>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-6 col-sm-6 col-md-6 col-lg-3">
				<div class="counter-wrap">
					<div class="counter">
						<span class="" data-number="<?php echo count($users) ?>">0</span>
					</div>
			...
			<div class="col-6 col-sm-6 col-md-6 col-lg-3">
				<div class="counter-wrap">
					<div class="counter">
						<span class="" data-number="<?php echo count($admins) ?>">0</span>
					</div>
	...
	<div class="container">
		...
		<div class="owl-carousel owl-3-slider">
			...
			foreach ($sites as $site) {
				// Unserialize the images field to get the array of images
				$images = unserialize($site['images']);
				$firstImage = $images[0]; // Select the first image

			?>
				<div class="item">
					<a class="media-thumb" href="user/booking.php" data-fancybox="gallery">
						<div class="media-text">
							<h3><?php echo htmlspecialchars($site['name']); ?></h3>
							<span class="location"><?php echo htmlspecialchars($site['location']); ?></span>
						</div>
						<img src="admin/<?php echo htmlspecialchars($firstImage); ?>" alt="Image" class="img-fluid">
					</a>
				</div>
			<?php
			}
	...
	<div class="container">
		<div class="row justify-content-between align-items-center">
			...
			<div class="col-lg-5">
				...
				<p>Embark on a journey with our state-of-the-art tourism management system, designed to enhance your travel experience from start to finish.</p>

				<p class="mb-4">Our platform offers seamless integration of travel services, ensuring a smooth and enjoyable adventure for every traveler.</p>
	...
	<div class="container">
		<div class="row text-center">
			<div class="col-md-12">
				...
				<p class="mb-4 lead text-white text-white-opacity">Join us for an unforgettable travel experience. Our team is ready to assist you with all your travel needs.</p>
				<p class="mb-0"><a href="user/" class="btn btn-outline-white text-white btn-md font-weight-bold">Get in touch</a></p>
			</div>
		</div>
	</div>
</div>
